...
const int YY_parse_CLASS::KEY=259;
const int YY_parse_CLASS::OP=260;
...
#define YYTRANSLATE(x) ((unsigned)(x) <= 260 ? yytranslate[x] : 7)
...
static const char * const yytname[] = {   "$","error","$illegal.","ID","KEY",
"OP","input",""
};
#endif
...
static const short yypact[] = {     1,
     1,     1,     1,-32768,-32768,-32768,     7,     8,-32768
};
