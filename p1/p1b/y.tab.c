...
/*#define YY_USE_CLASS 
*/
/*  A Bison++ parser, made from p1b.y  */
...
#define YYTRANSLATE(x) ((unsigned)(x) <= 258 ? yytranslate[x] : 12)
...
static const short yyrhs[] = {    11,
     0,    11,     3,    11,     0,    11,     4,    11,     0,    11,
     5,    11,     0,    11,     6,    11,     0,     8,    11,     9,
     0,     7,     0
};
...
-32768,     9,     8,    -3,     9,     9,     9,     9,-32768,    13,
    13,-32768,-32768,     5,    15,-32768
};
...
case 5:
#line 19 "p1b.y"
{if(yyvsp[0]==0) {printf("Divide by zero error\n");exit(0);} else yyval=yyvsp[-2]/yyvsp[0];;
    break;}
case 6:
#line 20 "p1b.y"
{yyval=yyvsp[-1];;
